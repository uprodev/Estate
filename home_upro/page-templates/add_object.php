...
<div class="content-add">
	...
	<div class="full-filter full-filter-page">
		<div class="full-filter-wrap">
			<form action="/img" class="form-filter">
				<div class="input-wrap input-wrap-popup input-wrap-img">
					...
					<div class="input-wrap-check input-wrap-check-more">
						...
						<div class="wrap flex">
							<div class="item">
								<input type="checkbox" name="check-10" id="check-10-1">
								<label for="check-10-1">Ексклюзив</label>
							</div>
							<div class="item">
								<input type="checkbox" name="check-10" id="check-10-2">
								<label for="check-10-2">Усна домовленість</label>
							</div>
							<div class="item">
								<input type="checkbox" name="check-10" id="check-10-3">
								<label for="check-10-3">Партнерський продаж</label>
							</div>
							<div class="item">
								<input type="checkbox" name="check-10" id="check-10-4">
								<label for="check-10-4">Бартер</label>
							</div>
							<div class="item">
								<input type="checkbox" name="check-10" id="check-10-5">
								<label for="check-10-5">Ключі</label>
							</div>
							<div class="item">
								<input type="checkbox" name="check-10" id="check-10-6">
								<label for="check-10-6">Об'єкт з дошки оголошень</label>
							</div>
						</div>
					</div>
					...
					<div class="input-wrap-check flex input-wrap-check-more ">
						<div class="wrap">
							<input type="checkbox" name="type-apartment" id="type-apartment-11">
							<label for="type-apartment-11">Пентхаус</label>
						</div>
						<div class="wrap">
							<input type="checkbox" name="type-apartment" id="type-apartment-21">
							<label for="type-apartment-21">Дворівнева</label>
						</div>
					</div>
					<div class="input-wrap ">
					...
					<div class="input-wrap-check input-wrap-check-more">
						<p class="label-info">Додати теги</p>
						<div class="wrap flex">
							<div class="item">
